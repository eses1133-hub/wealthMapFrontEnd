...
export class AssetService {
    ...
    getUserAssets(userId: number): Observable<AssetDTO[]> {
        const mockAssets: AssetDTO[] = [
            ...
            { id: 2, assetName: '中信定存', assetType: AssetType.CASH, currentValue: 30000, cost: 29800, returnPercentage: 0.67 },
            { id: 3, assetName: 'Apple Inc. (AAPL)', assetType: AssetType.STOCK, currentValue: 45000, cost: 42000, returnPercentage: 7.14 },
            { id: 4, assetName: '台積電 (2330)', assetType: AssetType.STOCK, currentValue: 35000, cost: 36000, returnPercentage: -2.78 },
            { id: 5, assetName: '全球平衡基金', assetType: AssetType.FUND, currentValue: 15000, cost: 14500, returnPercentage: 3.45 },
            { id: 6, assetName: '美國公債 ETF', assetType: AssetType.BOND, currentValue: 5000, cost: 5100, returnPercentage: -1.96 },
        ];
